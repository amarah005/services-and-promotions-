...
// Corrected imports
import { ServiceCard } from '../screens/Services/components/marketplace/ServiceCard';
import { ChatMessage } from '../screens/Services/chatbot/ChatLogic';
import { generateSmartResponse } from '../screens/Services/chatbot/GeminiService';
    ...
    return (
        <>
            <TouchableOpacity
                style={styles.fab}
                onPress={() => {
                    console.log('FloatingChat: Button Pressed');
                    setVisible(true);
                }}
                activeOpacity={0.8}
            >
...
const styles = StyleSheet.create({
    fab: {
        position: 'absolute',
        bottom: 80, // Moved up to avoid nav bars
        right: 24,
        width: 60,
        height: 60,
        borderRadius: 30,
